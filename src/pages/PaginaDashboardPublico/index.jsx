import {
  ...
  function PaginaInicial() {  // Nome da nova página
    const { usuarios } = useContext(UsuariosContext);
    const { pontosColeta, getPontosColeta } = useContext(PontosColetaContext);
  
    // Carrega os pontos de coleta quando a página é montada
    useEffect(() => {
      getPontosColeta();
    }, [getPontosColeta]);
          ...
          {pontosColeta.map((pontoColeta) => {
            return (
              <PontoColetaCard
                ...
                // Removemos as funções de edição e exclusão
              />
            );
          })}
        </Box>
